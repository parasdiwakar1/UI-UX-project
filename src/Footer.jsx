...
const Footer = () => {
  return (
    <footer className="bg-[#123557] text-white py-6"> 
      ...
      <hr className="border-t border-white w-[75.25rem] mx-auto" /> {/* Horizontal line with custom width of 49.25rem */}
    </footer>
  );
};
